...
<header>
        <nav class="nav-bar">
            ...
            <div class="nav-list">
                <ul>
                    <li onclick="abrirModal1()" class="nav-item"><a href="#" class="nav-link">adicionar fornecedor</a></li>
                    <li onclick="abrirModal2()" class="nav-item"><a href="#" class="nav-link">checar lista de fornecedores</a></li>
                </ul>
            </div>
            ...
            <div class="mobile-menu-icon">
              <button onclick="menuShow()"><img class="icon" src="icone-de-menu.png" width="50px" heigth="50px"></button>
            </div> 
        </nav>
                ...
                <defs>
                    ...
                    <g id="Aletas" transform="matrix(1, 0, 0, 1, 0, 0)">
                        <linearGradient id="LinearGradID_1" gradientUnits="userSpaceOnUse" gradientTransform="matrix(0.0935974, 0, 0, 0.188782, -20.55, 0)" spreadMethod="pad" x1="-819.2" y1="0" x2="819.2" y2="0">
                            ...
                            <stop offset="1" style="stop-color:#ff7b00;stop-opacity:1" />
                        </linearGradient>
                    ...
                    <g id="Espina" transform="matrix(1, 0, 0, 1, 0, 0)">
                        ...
                        <linearGradient id="LinearGradID_3" gradientUnits="userSpaceOnUse" gradientTransform="matrix(0.0229492, 0, 0, 0.0152893, 0, -0.05)" spreadMethod="pad" x1="-819.2" y1="0" x2="819.2" y2="0">
                            <stop offset="0" style="stop-color:#0dff00;stop-opacity:1" />
                            <stop offset="1" style="stop-color:#fb00ff;stop-opacity:1" />
                        </linearGradient>
